...
## 5.6 Teknik Looping
contoh program _**nama file : `5.6_looping.py`**_
...
contoh program _**nama file : `5.7.py`**_
...
contoh program _**nama file : `5.8_comparing.py`**_
